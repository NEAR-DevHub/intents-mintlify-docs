...
<Card title="Integration guide" icon="code" href="/intent-creators/examples">
  Add NEAR Intents to your wallet or application.
</Card>

<Card title="View fees" icon="dollar-sign" href="/resources/fees">
  Understand platform fees and authentication benefits.
</Card>

<Card title="API reference" icon="book" href="/api-reference/introduction">
  Explore the complete 1Click API documentation.
</Card>
</CardGroup>
