...
<Info>
There is an SDK for integrating this service: [Bridge SDK on GitHub](https://github.com/defuse-protocol/sdk-monorepo/tree/main/packages/intents-sdk). This SDK is under active development and may introduce breaking changes.
</Info>
